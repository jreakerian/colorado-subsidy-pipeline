...
final as (
  select
    ...
    dayofweek(date_day) + 1                                as day_of_week,   -- 1=Sunday, 7=Saturday (Snowflake DAYOFWEEK returns 0-6, shift by +1)
    ...
    case when dayofweek(date_day) + 1 in (1, 7) then true else false end as is_weekend
  from date_spine
)
