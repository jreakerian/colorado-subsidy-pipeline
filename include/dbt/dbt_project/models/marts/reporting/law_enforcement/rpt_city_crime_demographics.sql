{{
  config(
    ...
    meta={
      'owner': 'analytics',
      'kpis': ['city_kpi_3', 'city_kpi_5'],
      'description': 'City KPI 3 & 5. Average offender age and crime type distribution per city. One row per city × offense_category_name × crime_against.'
    }
  )
}}
